...
export default async function MyRecipesIngredients({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      <MyRecipeHero page="ingredients" recipe={recipe} />
      ...
      <section className="pb-[48px]">
        ...
        <ul>
          ...
          <li className="relative border-b-[1px] border-border px-[16px] py-[8px]">
            <p className="text-title text-[14px]">キムチ　少々</p>
            <p className="text-[10px] mt-[4px]">ディスクリプションが入ります</p>
