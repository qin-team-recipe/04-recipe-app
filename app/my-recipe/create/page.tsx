        ...
        <>
            ...
            <form>
                ...
                <section className=" pt-[8px] pb-[24px] ">
                    ...
                    <input className="bg-white w-full border-border border-b-[1px] py-[13px] px-[16px]" placeholder="例：肉じゃが">
                    </input>
                </section>
                ...
                <section className=" pt-[8px] pb-[24px] ">
                    ...
                    <ul className="bg-white">
                        <li className=" text-[14px] border-border border-b-[1px] leading-[18px]">
                            <input className="py-[15.5px] px-[16px] block text-title text-[14px] w-full" value="https://www.youtube.com/xxx">
                            </input>
                        </li>
                        <li className=" text-[14px] border-border border-b-[1px] leading-[18px]">
                            <input className="py-[15.5px] px-[16px] block text-title text-[14px] w-full" value="https://www.youtube.com/xxx">
