    ...
    <>
      ...
      <div className="px-[16px] pt-[16px] pb-[18.17px]">
        ...
        <div className="flex gap-x-[16px] text-title pt-[14.17px] text-[16px] leading-snug items-center">
          <div className="text-primary bg-white px-[12px] py-[2px] text-[14px] rounded-[4px] inline-block border-[1px] border-primary">
            公開中
          </div>
          <p>
        ...
        <div className="flex justify-center items-center gap-x-[16px] mt-[17px]">
          <div className="w-1/2 text-[14px] leading-[17px] py-[4px] text-primary rounded-[4px] border-primary border-[1px] text-center">
            お気に入りに追加済
          </div>
          <Link
            href="/my-recipe/1/edit"
            className="block text-center w-1/2 text-[14px] leading-[17px] py-[4px] text-title rounded-[4px] border-title border-[1px]"
          >
            レシピを編集
          </Link>
        </div>
